...
const data = {
  ...
  podcast: chalk.cyan('https://twitter.com/commitfm'),
  ...
  labelPodcast: chalk.white.bold('       Podcast:'),
...
const podcasting = `${data.labelPodcast}  ${data.web}`
const carding = `${data.labelCard}  ${data.npx}`

// Put all our output together into a single variable so we can use boxen effectively
const output = heading + newline + bio + newline + newline + working + newline + twittering + newline + githubing + newline + linkedining + newline + webing + newline + newline + podcasting + carding
